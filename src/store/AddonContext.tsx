...
export function getDefaultField(type: string): FieldDefinition {
  ...
  switch (type) {
    ...
    case "color_swatch":
      ...
      base.options = [
        { label: "", value: "", price_type: "flat", price: 0, weight: 0, color: "#3498db" },
      ];
      break;
    case "image_swatch":
      base.display_style = "swatch_label";
      base.options = [
        { label: "", value: "", price_type: "flat", price: 0, weight: 0, image_url: "" },
      ];
      break;
    case "text":
    case "textarea":
  ...
  switch (action.type) {
    ...
    case "DUPLICATE_FIELD": {
      ...
      const newField = {
        ...
        id: generateFieldId(),
        label: (originalField.label || "") + " " + __("(Copy)", "wpab-boilerplate"),
      };
